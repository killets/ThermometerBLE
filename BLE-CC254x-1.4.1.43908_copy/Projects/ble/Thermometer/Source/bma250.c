...
//    ACC_INT_ENABLE(ACC_INT_ENABLE1, ACC_INT_DATA_EN);//gj ACC_INT_S_TAP_EN
//#endif
//gj     
#ifdef BMA_250
    // *** New data interrupt on INT1, active high ***
    ...
    // Map New data interrupt to INT1
    accWriteReg(0x19, ACC_INT_MAP_S_TAP);

     // thrd
    accWriteReg(0x2B,0x10);
    
    // Enable new data interrupts
    ACC_INT_ENABLE(0x16, ACC_INT_S_TAP_EN);//gj 
    ACC_INT_ENABLE(0x17, 0x00);//gj 
